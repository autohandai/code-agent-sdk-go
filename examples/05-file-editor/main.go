// 05-file-editor demonstrates an agent that reads and edits files.
//
// Uses EDIT_FILE for surgical find-and-replace changes.
//
// Usage:
//
//	go run ./examples/05-file-editor
package main
...
func main() {
	...
	prompt := "Read README.md and fix any obvious typos in comments."
